...
import os
from utils import save_checkpoint, plot_losses, plot_images
...
def main():
    ...
    # Save model
    checkpoint_dir = "/home/wchung25/eee515/HW2/EEE515_HW2/checkpoint_gan"
    ...
    # Save loss plot
    plot_filename = os.path.join(checkpoint_dir, "gan_loss_plot.png")
    plot_losses(G_losses, D_losses, plot_filename)
    
    # Save image plot
    plot_filename = os.path.join(checkpoint_dir, "gan_realvsfake_plot.png")
