...
from train_gray import train_cnn, test_cnn
from utils import plot_losses, plot_accuracies, plot_confussion, save_checkpoint, evaluate_model
from config_gray import torch, num_epochs, device, testloader_color, testloader_gray
...
def main():
    ...
    # Save model
    checkpoint_dir = "/home/wchung25/eee515/HW2/EEE515_HW2/checkpoint_res_gray_cnn"
